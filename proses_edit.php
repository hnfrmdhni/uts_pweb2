...
if(isset($_FILES['file'])) {
    ...
    if (in_array($ext, $allowed_ext)) {
        ...
        if ($file_size < 2000000) {
            ...
            $query = "UPDATE users SET username='$username', password='$password', Kelas='$kelas', NIM='$nim', Jurusan='$jurusan', file_name='$new_name' WHERE id='$id'";
    ...
    $query = "UPDATE users SET username='$username', password='$password', Kelas='$kelas', NIM='$nim', Jurusan='$jurusan' WHERE id='$id'";
    $result = mysqli_query($koneksi, $query);
